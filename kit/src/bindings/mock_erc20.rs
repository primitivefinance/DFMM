...
pub mod mock_erc20 {
    ...
    /// with signature `initialize(string,string,uint8)` and selector
    /// `0x1624f6c6`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
