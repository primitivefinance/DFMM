...
pub mod dfmm_init {
    ...
    impl<M: ::ethers::providers::Middleware> DFMMInit<M> {
        ...
        /// Calls the contract's `test_DFMM_init_StoresStrategyInitialReserves`
        /// (0xc840a39e) function
        ...
        /// Calls the contract's `test_dfmm_init_emitsinitevent` (0x7822aceb)
        /// function
    ...
    /// Container type for all input parameters for the
    /// `test_DFMM_init_StoresStrategyInitialReserves` function with signature
    /// `test_DFMM_init_StoresStrategyInitialReserves()` and selector
    /// `0xc840a39e`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// `test_dfmm_init_emitsinitevent()` and selector `0x7822aceb`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    pub enum DFMMInitCalls {
        ...
        TestDFMMInitStoresStrategyInitialReserves(TestDFMMInitStoresStrategyInitialReservesCall),
    ...
    impl ::core::convert::From<TestDFMMInitStoresStrategyInitialReservesCall> for DFMMInitCalls {
