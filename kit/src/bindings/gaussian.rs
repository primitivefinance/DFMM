...
pub mod gaussian {
    ...
    #[rustfmt::skip]
    const __BYTECODE: &[u8] = b"`\x80\x80`@R4`\x17W`:\x90\x81`\x1D\x8290\x81PP\xF3[`\0\x80\xFD\xFE`\0\x80\xFD\xFE\xA2dipfsX\"\x12 \xD2\x88\x0En\xCE\x11\x91^}\xE5\xF9\xCE\xAE\xE3\x82\xE8\xF1d\xD5\xD23\xBF\x8D6\xCF*\xBD\xDDG\xAE\xB5xdsolcC\0\x08\x16\x003";
    /// The bytecode of the contract.
    pub static GAUSSIAN_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    const __DEPLOYED_BYTECODE: &[u8] = b"`\0\x80\xFD\xFE\xA2dipfsX\"\x12 \xD2\x88\x0En\xCE\x11\x91^}\xE5\xF9\xCE\xAE\xE3\x82\xE8\xF1d\xD5\xD23\xBF\x8D6\xCF*\xBD\xDDG\xAE\xB5xdsolcC\0\x08\x16\x003";
