...
pub mod g3m_set_up {
    ...
    impl ::core::convert::From<GetReservesAndLiquidityCall> for G3MSetUpCalls {
        fn from(value: GetReservesAndLiquidityCall) -> Self {
            Self::GetReservesAndLiquidity(value)
        }
    }
    impl ::core::convert::From<LiquidityOfCall> for G3MSetUpCalls {
