...
pub mod constant_sum_solver {
    ...
    ///Container type for all input parameters for the `preparePriceUpdate` function with signature `preparePriceUpdate(uint256)` and selector `0xa4232387`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for ConstantSumSolverCalls {
        fn decode(
            ...
            if let Ok(decoded) = <PreparePriceUpdateCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    ///Container type for all return fields from the `preparePriceUpdate` function with signature `preparePriceUpdate(uint256)` and selector `0xa4232387`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
