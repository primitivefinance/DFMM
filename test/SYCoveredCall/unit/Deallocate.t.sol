...
contract SYCoveredCallDeallocateTest is SYCoveredCallSetUp {
    function test_SYCoveredCall_deallocate_GivenX() public init {
    ...
    function test_SYCoveredCall_deallocate_GivenY() public init {
